...
-keep public class com.example.bbxpc.myapplication.retrofit.** {
    public void set*(***);
    public *** get*();
    public *** is*();
}
-keep public class com.example.bbxpc.myapplication.Bean.** {
    public void set*(***);
    public *** get*();
    public *** is*();
}
...
# 将下面替换成自己的实体类
-keep class com.example.bbxpc.myapplication.retrofit.** { *; }
